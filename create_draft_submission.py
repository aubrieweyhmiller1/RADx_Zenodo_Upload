#########################################
#########################################
# STEP 1 IN TRANSITION PROCESS (1) CREATE DRAFT UPLOADS IN SANDBOX TO CONFIRM WORKING (2) SUBMIT TO PROD ENVIRONMENT AND PUBLISH (WILL GO TO COMMUNITY)
# CREATES DRAFT SUBMISSIONS IN SANDBOX ENVIRONEMENT. 
# USE THIS TO CONFIRM CLEANED CSV FILE IS READING CORRECTLY AND ALL FILES ARE UPLOADING CORRECTLY.
...
if __name__ == "__main__":
	...
	try: 
		...
		for index, row in df.iterrows():
			...
			# adds folder path to file path depending on where input csv is located
			...
			try:
				...
				# Add successful file info to success dictionary
		...
		df.to_csv("./out/UP/failed_DRAFT_files.csv", index=False)
